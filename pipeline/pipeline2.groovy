if (params.Continuar != 'Sim') {
	...
	node {
        ...
        ansiColor('xterm') {
			...
			office365ConnectorSend message: 'Execucao Concluida.', status: 'End', webhookUrl: 'https://outlook.office.com/webhook/a88d86e7-7bd2-4b27-9837-b8b7cfb6199c@93f33571-550f-43cf-b09f-cd331338d086/JenkinsCI/55f96129989a4de2b7d70b7bcc7b08ab/a88d86e7-7bd2-4b27-9837-b8b7cfb6199c'
        }
	}
}
